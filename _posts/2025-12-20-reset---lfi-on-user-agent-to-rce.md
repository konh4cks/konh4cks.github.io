...
![Image](/assets/img/htb-writeups/Pasted image 20251128131852.png)

Reset Password > Intercept > Repeater > Send > We get reset password in request

![Image](/assets/img/htb-writeups/Pasted image 20251128134954.png)
Both empty

![Image](/assets/img/htb-writeups/Pasted image 20251128135020.png)
/var/log?

Update encoded parameter in post req:
file=%2Fvar%2Flog%2Fapache2%2Faccess.log
![Image](/assets/img/htb-writeups/Pasted image 20251128140112.png)
...
![Image](/assets/img/htb-writeups/Pasted image 20251128140752.png)
...
![Image](/assets/img/htb-writeups/Pasted image 20251128153515.png)
tmux session
```
...
![Image](/assets/img/htb-writeups/Pasted image 20251128162642.png)
sudo -l
![Image](/assets/img/htb-writeups/Pasted image 20251128162819.png)
...
![Image](/assets/img/htb-writeups/Pasted image 20251128163237.png)
reset; bash 1>&0 2>&0
![Image](/assets/img/htb-writeups/Pasted image 20251128163454.png)
